...
import os.path
from novo.apps.activities.models import Notification
...
class Profile(models.Model):
    ...
    STATUS = Choices('Comercial', 'Industrial', 'Servicio', 'Otros')
    titulo = models.CharField(max_length=50, default='Original')
    nit = models.PositiveIntegerField(null=True, blank=True)
    fecha_fun = models.DateField(auto_now_add=True, null=True, blank=True)
    direccion = models.CharField(max_length=50, null=True, blank=True)
    tipo = models.CharField(choices=STATUS, default=STATUS.Otros, max_length=20)
    obj_actividad = models.CharField(max_length=50, null=True, blank=True)
    acronimo = models.CharField(max_length=50, null=True, blank=True)
