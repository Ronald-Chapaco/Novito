...
from novo.apps.usu.forms import ProfileForm, ChangePasswordForm
from novo.apps.feeds.models import Feed
from novo.apps.feeds.views import FEEDS_NUM_PAGES
from novo.apps.feeds.views import feeds
...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.profile.titulo = form.cleaned_data.get('titulo')
            user.profile.fax = form.cleaned_data.get('fax')
            user.profile.nit = form.cleaned_data.get('nit')
            user.profile.fecha_fun = form.cleaned_data.get('fecha_fun')
            user.save()
        ...
        form = ProfileForm(instance=user, initial={
            ...
            'fecha_fun': user.profile.fecha_fun
            })
